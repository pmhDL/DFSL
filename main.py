...
from trainer.dfsl import DFSLTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='mini', choices=['mini', 'tiered', 'cifar_fs', 'cub'])
    parser.add_argument('--phase', type=str, default='train', choices=['pre', 'preval', 'train', 'test'])
    ...
    parser.add_argument('--addVal', type=int, default=0)
    parser.add_argument('--init_weights', type=str, default='./data/checkpoints/mini')
    parser.add_argument('--eval_weights', type=str, default='./data/checkpoints/mini')
